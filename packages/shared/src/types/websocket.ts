export enum WsMessageType {
  ...
  SESSION_UNASSIGN_TASK = 'SESSION_UNASSIGN_TASK', // Unlink task from current session
  ...
  SESSION_TASK_UNASSIGNED = 'SESSION_TASK_UNASSIGNED', // Server confirms task unassignment
